...
from cry_diagnosis.machine_learning_model.baby_cry_detection.pc_methods.train_classifier import TrainClassifier


def main():
    parser = argparse.ArgumentParser()
    parser.add_argument('--load_path',
                        default='{}/../../../baby_cry_detection-master/output/dataset/'.format(os.path.dirname(os.path.abspath(__file__))))
